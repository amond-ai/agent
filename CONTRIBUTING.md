...
```bash
git clone https://github.com/amond-ai/agent.git
cd agent
...
| -------------------------------- | ---------------- | ------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| Report a bug or propose a fix    | an **Issue**     | [New issue](https://github.com/amond-ai/agent/issues/new/choose)                 | [`.github/ISSUE_TEMPLATE/`](.github/ISSUE_TEMPLATE)                              |
| Request a feature or enhancement | a **Discussion** | [New discussion](https://github.com/amond-ai/agent/discussions/categories/ideas) | [`.github/DISCUSSION_TEMPLATE/ideas.yml`](.github/DISCUSSION_TEMPLATE/ideas.yml) |
